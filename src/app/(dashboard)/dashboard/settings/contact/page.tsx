...
import { StepContactInfo, StepLocation, StepDisplaySettings } from '@/components/dashboard/settings/contact-section';
        ...
        <>
          ...
          <div className="hidden lg:flex lg:flex-col lg:h-full">
            ...
            <div className="flex-1 min-h-[340px]">
              ...
              {currentStep === 2 && (
                <StepDisplaySettings {...stepProps} tenantEmail={tenant?.email || ''} tenantSlug={tenant?.slug || ''} isDesktop />
              )}
            </div>
          ...
          <div className="lg:hidden flex flex-col pb-24">
            ...
            <div className="min-h-[300px]">
              ...
              {currentStep === 2 && (
                <StepDisplaySettings {...stepProps} tenantEmail={tenant?.email || ''} tenantSlug={tenant?.slug || ''} />
              )}
            </div>
          </div>
        </>

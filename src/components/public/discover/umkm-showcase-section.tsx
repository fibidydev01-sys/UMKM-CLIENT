// ══════════════════════════════════════════════════════════════
// UMKM SHOWCASE SECTION - V2.0 REFACTORED
...
import { fetchAllTenants, getCategoryLabel, getInitials } from '@/lib/public/discover';
  ...
  useEffect(() => {
    async function loadTenants() {
      try {
        ...
        const validTenants = await fetchAllTenants(12);

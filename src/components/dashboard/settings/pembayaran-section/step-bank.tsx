...
export function StepBank({ formData, onAdd, onDelete, onToggle, isDesktop = false }: StepBankProps) {
      ...
      <div className="space-y-5 max-w-xl">
        ...
        {isEmpty ? (
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Click to add a bank account</p>
          </div>
        ) : (

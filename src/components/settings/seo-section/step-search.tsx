  ...
  return (
    <div className="rounded-lg border bg-white dark:bg-muted/10 p-4 space-y-0.5">
      <div className="flex items-center gap-1.5 mb-1.5">
        ...
        <span className="text-[11px] text-muted-foreground">{slug ?? 'your-store'}.fibidy.com</span>
      </div>
      ...
      <p className="text-[13px] text-emerald-700 dark:text-emerald-500">{slug ?? 'your-store'}.fibidy.com</p>
      ...
      <div className="grid grid-cols-[1fr_320px] gap-10 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="metaTitle-d"
              placeholder={tenantName || 'Your store name'}
              maxLength={70}
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <span className="font-medium text-foreground">ideal 50–60 characters</span>
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Shown below your title in search results —{' '}
              <span className="font-medium text-foreground">ideal 120–160 characters</span>
            </p>
          </div>

          <div className="border-l-2 border-muted-foreground/20 pl-4 py-0.5">
            <p className="text-xs text-muted-foreground leading-relaxed">
              <span className="font-medium text-foreground">SEO Tip:</span>{' '}
              Include your store name and main keywords in the Meta Title. A compelling Meta Description improves your click-through rate from Google.
            </p>
          </div>
        </div>

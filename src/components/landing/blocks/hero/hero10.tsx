...
// Hero10: Marquee Split — Scrolling store name ticker + bold two-column layout.
export function Hero10({
  ...
  const marqueeText = Array(8).fill(storeName ?? 'Store').join(' · ');
  ...
  return (
    <section className="relative min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        {/* Left — Image */}
        <div className="relative lg:w-5/12 min-h-[45vh] lg:min-h-0 bg-muted overflow-hidden border-r border-border">
          {backgroundImage ? (
            <OptimizedImage
              src={backgroundImage}
              alt={title}
        ...
        <div className="flex-1 flex flex-col justify-between p-8 sm:p-12 lg:p-16">
          ...
          <div className="py-10">
            ...
            <h1
              className="font-black leading-[0.92] tracking-[-0.03em] text-foreground"
            ...
            {subtitle && (
              <p className="mt-7 max-w-sm text-sm text-muted-foreground leading-relaxed">
                {subtitle}
              </p>
            )}
          </div>
          ...
          {showCta && (
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-medium">

...
// Hero8: Brutalist Grid — raw borders, massive type, asymmetric image inset.
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_auto] divide-y lg:divide-y-0 lg:divide-x divide-border">
        ...
        <div className="flex flex-col justify-between p-6 sm:p-10">
          ...
          <div className="mt-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            {subtitle && (
              <p className="max-w-xs text-xs text-muted-foreground leading-relaxed border-l-2 border-foreground/40 pl-4">
                {subtitle}
              </p>
            )}
            {showCta && (
        ...
        {/* Right — Image box */}
        <div className="relative w-full lg:w-[38vw] min-h-[50vh] lg:min-h-0 bg-muted overflow-hidden">
          {backgroundImage ? (
            <OptimizedImage
              src={backgroundImage}
              alt={title}
